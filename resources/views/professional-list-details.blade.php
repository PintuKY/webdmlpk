                  ...
                  <div class="list-pg-lt list-page-com-p">
                     ...
                     <div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
                        <div class="pglist-p-com-ti">
                           <h3><span>About</span> Advocate 1 </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           ...
                           <p>An advocate is a professional in the field of law. 
						   Different countries' legal systems use the term with 
						   somewhat differing meanings. The broad equivalent in
						   many English law–based jurisdictions could be a 
                     ...
                     <div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
                        <div class="pglist-p-com-ti">
                           <h3><span>Advocate</span> Services</h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <p> An advocate is a professional in the field of law. 
						   Different countries' legal systems use the term with
						   somewhat differing meanings
                           </p>
                   ...
                   <!--  <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-gal">
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-vie">
                        <div class="pglist-p-com-ti">
                           <h3><span>Advocate </span> Location</h3>
                        </div>
                  ...
                  <div class="list-pg-rt">
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                           <h3><span>Advocate </span> Services with Charges</h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                              <ul>
							     <li>Service 1 <span class="green-bg">10,000</span> </li>
								 <li>Service 2 <span class="green-bg">15,000</span> </li>
								 <li>Service 3 <span class="green-bg">20,000</span> </li>
				   ...
				   <!--LISTING DETAILS: LEFT PART 9-->
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                           <h3><span>Advocate  </span> Enquiry </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                             <form>
