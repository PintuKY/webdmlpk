         ...
         <div class="container">
            <div class="row">
               <div class="dir-alp-tit">
                  <h1>Homestay in Coorg</h1>
                  <ol class="breadcrumb">
                     <li><a href="#">Home</a> </li>
                     <li><a href="#">Listing</a> </li>
                     <li class="active">Stay Booking List</li>
                  </ol>
               </div>
            </div>
            <div class="row">
                     ...
                     <div class="dir-alp-con-right-1">
                        <div class="row">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/list/homestay.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="stay-booking-list-details">
                                    <h3>Star Homestay</h3>
                                 </a>
                                 <h4>Madkeri</h4>
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/list/homestay2.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="stay-booking-list-details">
                                    <h3>Regal Homestay</h3>
                                 </a>
                                 <h4>Madkeri</h4>
                                 <p><b>Address:</b> #123 Sky Building Mahadevapet Madikeri, MADIKERI 571201</p>
                                 <div class="list-number">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/list/homestay3.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="stay-booking-list-details">
                                    <h3>Lotus Homestay</h3>
                                 </a>
                                 <h4>Madkeri</h4>
                                 <p><b>Address:</b> #123 Sky Building Mahadevapet Madikeri, MADIKERI 571201</p>
                                 <div class="list-number">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/list/homestay4.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="stay-booking-list-details">
                                    <h3>View Point Homestay</h3>
                                 </a>
                                 <h4>Madkeri</h4>
                                 <p><b>Address:</b> #123 Sky Building Mahadevapet Madikeri, MADIKERI 571201</p>
                                 <div class="list-number">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/list/homestay5.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="stay-booking-list-details">
                                    <h3>Male Hani Homestay</h3>
                                 </a>
                                 <h4>Madkeri</h4>
                                 <p><b>Address:</b> #123 Sky Building Mahadevapet Madikeri, MADIKERI 571201</p>
                                 <div class="list-number">
