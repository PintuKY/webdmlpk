               ...
               <div class="com-padd">
                  <div class="list-pg-lt list-page-com-p">
                     ...
                     <div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
                        <div class="pglist-p-com-ti">
                           <h3><span>About</span> Star Homestay </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           ...
                           <p> Homestay in Coorg is the place you should stay
                              when you are in one of the top tourist destinations in 
                              Karnataka. Many of home stay in coorg are part of 
                              working plantations and serve traditional Coorgi
                              food, giving guests a unique dose of local culture.
                              Deciding which one to pick can be difficult, as 
                              they're all so appealing. However, there are a
                              few things to keep in mind.
                           </p>
                           <p>Homestay in Coorg is the place you should stay when
                              you are in one of the top tourist destinations in Karnataka.
                              Many of home stay in coorg are part of working plantations
                              and serve traditional Coorgi food, giving guests a unique
                              dose of local culture. Deciding which one to pick can be 
                              difficult, as they're all so appealing. However, there 
                     ...
                     <div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
                        ...
                        <div class="list-pg-inn-sp">
                           <p>Star Homestay provide 24-hour Internet Access.
                              Best Rooms, Breakfast lunch, Dinner, Music Events,
                              Sports, House Doctor on Call, Picup and drop Service,
                           </p>
                           <div class="row pg-list-ser">
                              <ul>
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/list/food.png" alt="" /> 
                                    </div>
                                 ...
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/list/ser2.jpg" alt="" /> 
                                    </div>
                                    <div class="pg-list-ser-p2">
                                       <h4>Room</h4>
                                    </div>
                                 ...
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/list/ser3.jpg" alt="" /> 
                                    </div>
                                    <div class="pg-list-ser-p2">
                                 ...
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/list/sports.jpg" alt="" /> 
                                    </div>
                                    <div class="pg-list-ser-p2">
                                       <h4>Sports</h4>
                                    </div>
                                 ...
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/list/ser5.jpg" alt="" /> 
                                    </div>
                                    <div class="pg-list-ser-p2">
                                 ...
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/list/swim.jpg" alt="" /> 
                                    </div>
                                    <div class="pg-list-ser-p2">
                                       <h4>Swimming Fool</h4>
                                    </div>
                        ...
                        <div class="list-pg-inn-sp">
                           <div id="myCarousel" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                 <div class="item active"> <img src="images/list/gal1.jpg" alt="madkeri"> </div>
                                 <div class="item"> <img src="images/list/gal2.jpg" alt="madkeri"> </div>
                                 <div class="item"> <img src="images/list/gal3.jpg" alt="madkeri"> </div>
                                 <div class="item"> <img src="images/list/gal4.jpg" alt="madkeri"> </div>
                              </div>
					...
					<!--LISTING DETAILS: LEFT PART 4-->
                     <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-roo">
                        ...
                        <div class="list-pg-inn-sp">
                           <div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3"> <img src="images/list/homestay.jpg" alt=""> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta">
								 ...
								 <span>5.0</span> <i class="fa fa-star" aria-hidden="true"></i>
								 <i class="fa fa-star" aria-hidden="true"></i> 
								 <i class="fa fa-star" aria-hidden="true"></i>
								 <i class="fa fa-star" aria-hidden="true"></i> 
								 <i class="fa fa-star" aria-hidden="true"></i>
                                 ...
                                 <span class="home-list-pop-rat list-rom-pric">Rs 940</span>
                                 <div class="list-enqu-btn">
                                    <ul>
                                       <li><a href="#!"><i class="fa fa-inr" aria-hidden="true"></i> Get Quotes</a> </li>
                                       <li><a href="#!"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</a> </li>
                                       <li><a href="#!"><i class="fa fa-phone" aria-hidden="true"></i> Call Now</a> </li>
                                       <li><a href="#!"><i class="fa fa-inr" aria-hidden="true"></i> Book Now</a> </li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-vie">
                        <div class="pglist-p-com-ti">
                           <h3><span>Homestay </span> Location</h3>
                        </div>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1993064.5568319485!2d75.32154048212585!3d12.667388826865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba5007546c508b5%3A0x5f20dceb5534f701!2sCOORG%20DIAL!5e0!3m2!1sen!2sin!4v1621243981749!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                  ...
                  <div class="list-pg-rt">
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        ...
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                              <ul>
							     <li>From Date <span class="green-bg">17/5/2021</span> </li>
								 <li>To Date <span class="green-bg">18/5/2021</span> </li>
							  
                                 <li>Adults  (2)<span class="green-bg">Rs 2500</span> </li>
                                 <li>Childrens (2) <span class="green-bg">Rs 1000</span> </li>
                                 <li>Parking <span class="green-bg">Rs 100</span></li>
								 
                                <h4>Total  <span> <h1>Rs 3600 </h1></span> </h4>
                              </ul>
							   <a class="waves-effect waves-light btn-large full-btn list-pg-btn" href="#!">Pay Now</a> 
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                           <h3><span>Homestay </span> Price </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                  ...
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1993064.5568319485!2d75.32154048212585!3d12.667388826865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba5007546c508b5%3A0x5f20dceb5534f701!2sCOORG%20DIAL!5e0!3m2!1sen!2sin!4v1621243981749!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                           </div>
                        </div>
                     </div>
