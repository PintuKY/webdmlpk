         ...
         <div class="container">
            <div class="row">
               <div class="dir-alp-tit">
                  <h1>Travels in Coorg</h1>
                  <ol class="breadcrumb">
                     <li><a href="#">Home</a> </li>
                     <li><a href="#">Listing</a> </li>
                     <li class="active">Travels List</li>
                  </ol>
               </div>
            </div>
            <div class="row">
               <div class="dir-alp-con">
                  <div class="col-md-3 dir-alp-con-left">
                     <div class="dir-alp-con-left-1">
                        <h3>Nearby Travels (07)</h3>
                     </div>
                     <div class="dir-hom-pre dir-alp-left-ner-notb">
                        <ul>
                           <!--==========NEARBY LISTINGS============-->
                           <li>
                              <a href="pick-drop-booking-list-details">
                     ...
                     <div class="dir-alp-con-right-1">
                        <div class="row">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/travel/t1.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
