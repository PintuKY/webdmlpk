                     ...
                     <div class="dir-alp-con-right-1">
                        <div class="row">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/food/r1.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="food-menu-list">
                                    <h3>Anand Restaurant</h3>
                                 </a>
                                 <h4>Madkeri</h4>
