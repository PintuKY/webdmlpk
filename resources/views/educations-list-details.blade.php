                  ...
                  <div class="list-pg-lt list-page-com-p">
                     ...
                     <div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
                        <div class="pglist-p-com-ti">
                           <h3><span>About</span> Best School </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           ...
                           <p> Best  Residential English Medium High 
						   School is located in Shiramagondanahalli Post, Madkeri - 232323 
						   is a Co-Educational Secondary School institution. CBSE Schools in 
						   Madkeri, Residentials Schools in Madkeri, Schools in Madkeri,
						   Boarding Schools in Madkeri, Best Schools in
						   Madkeri. Schools with all essential facilities. 
						   School in Madkeri,CBSE Schools in Madkeri,
						   Residential Schools in Madkeri, Schools in
						   Madkeri, Boarding Schools in Madkeri,
						   CBSE Schools in Madkeri, Best Schools in 
						   Madkeri, Top Schools in Madkeri CBSE Schools in Madkeri"
                           </p>
                     ...
                     <div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
                        <div class="pglist-p-com-ti">
                           <h3><span>School</span> Facilities</h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <p> Best  Residential English Medium High 
						   School is located in Shiramagondanahalli Post,
                           </p>
                           <div class="row pg-list-ser">
                              <ul>
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/school/s1.jpg" alt="" /> 
                                    </div>
                   ...
                   <!--  <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-gal">
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-vie">
                        <div class="pglist-p-com-ti">
                           <h3><span>School </span> Location</h3>
                        </div>
                  ...
                  <div class="list-pg-rt">
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                           <h3><span>School </span> Fees Details </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                              <ul>
							     <li>1std <span class="green-bg">15,000</span> </li>
								 <li>2nd <span class="green-bg">15,000</span> </li>
								 <li>3rd <span class="green-bg">20,000</span> </li>
								 <li>4th <span class="green-bg">25,000</span> </li>
								 <li>5th <span class="green-bg">26,000</span> </li>
								 <li>6th <span class="green-bg">27,000</span> </li>
								 <li>7th <span class="green-bg">29,000</span> </li>
								 <li>8th <span class="green-bg">30,000</span> </li>
								 <li>9th <span class="green-bg">35,000</span> </li>
								 <li>10th <span class="green-bg">50,000</span> </li>
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                           <h3><span>School  </span> Enquiry </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                             <form>
							   ...
							   <a class="waves-effect waves-light btn-large full-btn list-pg-btn" href="#!">Enquiry Now</a> 
                           </div>
                        </div>
                     </div>
                     <!--END LISTING DETAILS: LEFT PART 9-->
