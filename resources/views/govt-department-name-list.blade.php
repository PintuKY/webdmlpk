         ...
         <div class="container">
            <div class="row">
               <div class="dir-alp-tit">
                  <h1>Government Department in Coorg</h1>
                  <ol class="breadcrumb">
                     <li><a href="#">Home</a> </li>
               ...
               <div class="dir-alp-con">
                  <div class="col-md-3 dir-alp-con-left">
                     <div class="dir-alp-con-left-1">
                        <h3>Nearby Department (02)</h3>
                     </div>
                     <div class="dir-hom-pre dir-alp-left-ner-notb">
                        <ul>
                           <!--==========NEARBY LISTINGS============-->
                           <li>
                              <a href="govt-department-name-list">
                     ...
                     <div class="dir-alp-con-right-1">
                        <div class="row">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/s-services/govt.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="#">
                                    <h3>Department of Horticulture Government</h3>
                                 </a>
                                 <h4>Madkeri</h4>
