         ...
         <div class="container">
            <div class="row">
               <div class="dir-alp-tit">
                  <h1>Professionals in Coorg</h1>
                  <ol class="breadcrumb">
                     <li><a href="#">Home</a> </li>
                     <li><a href="#">Listing</a> </li>
                     <li class="active">Professional List</li>
                  </ol>
               </div>
            </div>
            <div class="row">
                     ...
                     <div class="dir-alp-con-right-1">
                        <div class="row">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/professional/p1.jpeg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
