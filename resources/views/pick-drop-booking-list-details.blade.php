            ...
            <div class="row">
                  ...
                  <div class="list-pg-lt list-page-com-p">
                     ...
                     <div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
                        <div class="pglist-p-com-ti">
                           <h3><span>About</span> Anand Travels </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           ...
                           <p> Anand is one of the front runners in the Indian Passenger 
						   Travel Industry amongst the private sector players. These 
						   operations are conducted under the aegis of Anand 
						   TRAVELS” covering more than 350 routes connecting nearly
						   100 destinations with over 362 luxury Buses / Coaches.
						   It is the Market Leader in Karnataka's Private Passenger
						   Travel Industry. Our customer have the choice of several
						   bus types, viz. AC / Non A/c Sleeper coach, AC / Non A/c 
						   Semi Sleeper / Seater, etc. Our fleet comprises a wide
						   range of vehicles of several makes such as Volvo, Isuzu,
						   Ashok Leyland, etc to cater to every customer pocket 
						   preference.
                           </p>
               ...
               <!--      <div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
                              ...
                              <ul>
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/travel/t1.png" alt="" /> 
                                    </div>
                        ...
                        <div class="list-pg-inn-sp">
                           <div id="myCarousel" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                 <div class="item active"> <img src="images/travel/t1.jpg" alt="madkeri"> </div>
                                 <div class="item"> <img src="images/travel/t1.jpg" alt="madkeri"> </div>
                                 <div class="item"> <img src="images/travel/t1.jpg" alt="madkeri"> </div>
                                 <div class="item"> <img src="images/travel/t1.jpg" alt="madkeri"> </div>
                              </div>
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-vie">
                        <div class="pglist-p-com-ti">
                           <h3><span>Anand Travel </span> Location</h3>
                        </div>
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        ...
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                              <ul>
							     <li>From Date <span class="green-bg">25/5/2021</span> </li>
								 <li>To Date <span class="green-bg">28/5/2021</span> </li>
							  
                                 <li>Total Seats (5)<span class="green-bg">Rs 20000</span> </li>
                                 <li>Parking <span class="green-bg">Rs 500</span></li>
								 
                                <h4>Total  <span> <h1>Rs 20500 </h1></span> </h4>
                              </ul>
