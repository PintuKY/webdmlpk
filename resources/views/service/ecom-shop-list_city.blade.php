         ...
         <div class="dir-alp-con">
            <div class="col-md-3 dir-alp-con-left">
               <div class="dir-alp-con-left-1">
                  @if($main->type=="ecom")
                  <h3>Nearby Shops ({{$items}})</h3>
                  @elseif($main->type=="education")
                  <h3>Nearby Educational Institutions ({{$items}})</h3>
                  @elseif($main->type=="health")
                  <h3>Nearby Hospitals ({{$items}})</h3>
                  @elseif($main->type=="professional")
                  <h3>Nearby Professionals ({{$items}})</h3>
                  @elseif($main->type=="service")
                  <h3>Nearby Service Providers ({{$items}})</h3>
                  @elseif($main->type=="staybooking")
                  <h3>Nearby Hotels ({{$items}})</h3>
				   @elseif($main->type=="pd")
                  <h3>Nearby Transports ({{$items}})</h3>
                  @else
                  <h3>Nearby Shops ({{$items}})</h3>
                  @endif</div>
               <div class="dir-hom-pre dir-alp-left-ner-notb">
                  <ul>
                     ...
                     @foreach($nearby_shop->sellers->where('status','Active') as $seller1)
					  ...
					  @if($seller1->user->city_id == @$city->id)
					  <?php
					  $now = date("H:i");
					  $close = 0;
					  ...
					  ?>
                        ...
                        <li>
                           @if($main->type=="ecom") 
                              <a @if($close == 1) href="#" href="{{url('shop',$seller1->id)}}" @endif>
                           @elseif($main->type=="service")
                              <a @if($close == 1) href="#" href="{{url('sellerAllServices',$seller1->id)}}" @endif>
                           @elseif($main->type=="education")
                              <a @if($close == 1) href="#" href="{{url('educationList',$seller1->id)}}" @endif>
                           @elseif($main->type=="health")
                              <a @if($close == 1) href="#" href="{{url('hospitalList',$seller1->id)}}" @endif>
                           @elseif($main->type=="staybooking")
                              <a @if($close == 1) href="#" href="{{url('stay-booking',$seller1->id)}}" @endif>
