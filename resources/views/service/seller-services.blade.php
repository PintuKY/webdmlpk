                        ...
                        <ul>
                            ...
                            <div class="modal fade dir-pop-com" id="list-quo-reviews{{$shop->id}}"
                             ...
                             <li><a href="#" data-dismiss="modal" data-toggle="modal" data-target="#list-quo{{$shop->id}}"><i
                                        class="fa fa-inr" aria-hidden="true"></i> Book Now</a></li>
							<!-- GET QUOTES POPUP -->
                ...
                <div class="com-padd">
                    <div class="list-pg-lt list-page-com-p">
                        ...
                        <div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
                            <div class="pglist-p-com-ti">
                                <h3><span>{{$shop->shop_name}}</span> Services</h3>
                            </div>
                            <div class="list-pg-inn-sp">
                    ...
                    <div class="list-pg-rt">
                        ...
                        <div class="pglist-p3 pglist-bg pglist-p-com">
                            <div class="pglist-p-com-ti pglist-p-com-ti-right">
                                <h3><span> {{$shop->shop_name}} </span> Services with Charges</h3>
                            </div>
                            <div class="list-pg-inn-sp">
										 ...
										 @if($main->type=="pd")
                                            @foreach($services as $service)
                                                <a href="{{url('sellerServices/'.$shop->id.'/service',$service->id)}}}}">
                                                    <li>{{$service->name}}<span
                                                            class="green-bg">Per Km &#x20B9;{{$service->price}}</span></li>
                                                </a>
                                            @endforeach
                                        @else
                                        @foreach($services as $service)
...
@endif
                        ...
                        <div class="pglist-p3 pglist-bg pglist-p-com">
                            <div class="pglist-p-com-ti pglist-p-com-ti-right">
                                <h3><span>{{$shop->shop_name}}  </span> Enquiry </h3>
                            </div>
                            <div class="list-pg-inn-sp">
                                <div class="list-pg-oth-info">
                                    <form method="post" action="{{route('saveQuote')}}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="" placeholder="Enter Mobile" name="phone" required>
                                        </div>
 ...
 <button type="submit" class="waves-effect waves-light btn-large full-btn list-pg-btn">Enquiry Now</button>
