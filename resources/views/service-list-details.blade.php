                  ...
                  <div class="list-pg-lt list-page-com-p">
                     ...
                     <div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
                        <div class="pglist-p-com-ti">
                           <h3><span>About</span> Manpower Service </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           ...
                           <p>OTS Manpower contract-to-hire staffing module is 
						   the made-to-order solution wherein the companies 
						   looking for its expansion plans can take this risk
						   less staffing module. Contract- to- Hire module is
						   a safe alternative to permanent hiring.
                     ...
                     <div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
                        <div class="pglist-p-com-ti">
                           <h3><span>Manpower</span> Services</h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <p> Manpower contract-to-hire staffing module is 
						   the made-to-order solution wherein the companies 
                           </p>
                              ...
                              <ul>
                                 <li class="col-md-4">
                                    <div class="pg-list-ser-p1">
                                       <img src="images/professional/p1.jpeg" alt="" /> 
                                    </div>
                   ...
                   <!--  <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-gal">
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com" id="ld-vie">
                        <div class="pglist-p-com-ti">
                           <h3><span>Manpower Service 1 </span> Location</h3>
                        </div>
                  ...
                  <div class="list-pg-rt">
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                           <h3><span> ManPower </span> Services with Charges</h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                              <ul>
							     <li>Service 1 <span class="green-bg">5,000</span> </li>
								 <li>Service 2 <span class="green-bg">10,000</span> </li>
								 <li>Service 3 <span class="green-bg">15,000</span> </li>
				   ...
				   <!--LISTING DETAILS: LEFT PART 9-->
                     ...
                     <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                           <h3><span>Manpower Service  </span> Enquiry </h3>
                        </div>
                        <div class="list-pg-inn-sp">
                           <div class="list-pg-oth-info">
                             <form>
