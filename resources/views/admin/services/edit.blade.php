       ...
       <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
              ...
              @endif
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('services.update',$data->id) }}">
                @csrf
                @method('PATCH')
                <div class="container">
                 <div class="row">
                    <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" min="0" name="commission" class="form-control" placeholder="Enter Commision in %" value="{{$data->commission}}" />
                            ...
                            <div class="form-group">
                            <img src="{{ URL::to('/') }}/uploads/images/{{ @$data->image }}" style="width: 300px;" /><br>
