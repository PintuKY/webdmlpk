         ...
         <div class="container">
            <div class="row">
               <div class="dir-alp-tit">
                  <h1>Food Menu now in Subbisky</h1> 
                  <ol class="breadcrumb">
                     <li><a href="#">Home</a> </li>
                        ...
                        <div class="row">
					          ...
					          <div class="col-md-4">
									<div class="home-list-pop">
										...
										<img src="images/food/gobi.jpg" alt="" /> </div>
										<!--POPULAR LISTINGS: CONTENT-->
										<div class="col-md-12"> 
										<a href="single-product-details"><h3> Gobi Manchuri</h3></a>
							   ...
							   <div class="col-md-4">
									<div class="home-list-pop">
										<!--POPULAR LISTINGS IMAGE-->
										<div class="col-lg-12 col-md-6 col-sm-6 col-xs-6"> 
										<img src="images/food/paneer.jpg" alt="" /> </div>
										<!--POPULAR LISTINGS: CONTENT-->
										<div class="col-md-12"> 
										<a href="single-product-details"><h3>Paneer Masala</h3></a>
							   ...
							   <div class="col-md-4">
									<div class="home-list-pop">
										<!--POPULAR LISTINGS IMAGE-->
										<div class="col-lg-12 col-md-6 col-sm-6 col-xs-6"> 
										<img src="images/food/daal.jpg" alt="" /> </div>
										<!--POPULAR LISTINGS: CONTENT-->
										<div class="col-md-12"> 
										<a href="single-product-details"><h3>Daal Tadka</h3></a>
							   ...
							   <div class="col-md-4">
									<div class="home-list-pop">
										<!--POPULAR LISTINGS IMAGE-->
										<div class="col-lg-12 col-md-6 col-sm-6 col-xs-6"> 
										<img src="images/food/lemon.jpg" alt="" /> </div>
										<!--POPULAR LISTINGS: CONTENT-->
										<div class="col-md-12"> 
										<a href="single-product-details"><h3>Lemon Rice</h3></a>
							   ...
							   <div class="col-md-4">
									<div class="home-list-pop">
										<!--POPULAR LISTINGS IMAGE-->
										<div class="col-lg-12 col-md-6 col-sm-6 col-xs-6"> 
										<img src="images/food/jeera.jpg" alt="" /> </div>
										<!--POPULAR LISTINGS: CONTENT-->
										<div class="col-md-12"> 
										<a href="single-product-details"><h3>Jeera Rice</h3></a>
							   ...
							   <div class="col-md-4">
									<div class="home-list-pop">
										<!--POPULAR LISTINGS IMAGE-->
										<div class="col-lg-12 col-md-6 col-sm-6 col-xs-6"> 
										<img src="images/food/g65.jpg" alt="" /> </div>
										<!--POPULAR LISTINGS: CONTENT-->
										<div class="col-md-12"> 
										<a href="single-product-details"><h3>Gobi 65</h3></a>
