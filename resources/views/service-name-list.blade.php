         ...
         <div class="container">
            <div class="row">
               <div class="dir-alp-tit">
                  <h1>Service Providers in Coorg</h1>
                  <ol class="breadcrumb">
                     <li><a href="#">Home</a> </li>
                     <li><a href="#">Listing</a> </li>
                     <li class="active">Service Providers List</li>
                  </ol>
               </div>
            </div>
            <div class="row">
               <div class="dir-alp-con">
                  <div class="col-md-3 dir-alp-con-left">
                     <div class="dir-alp-con-left-1">
                        <h3>Nearby Service Providers (07)</h3>
                     </div>
                     <div class="dir-hom-pre dir-alp-left-ner-notb">
                        <ul>
                           <!--==========NEARBY LISTINGS============-->
                           <li>
                              <a href="professional-list-details">
                                 <div class="list-left-near lln1"> 
                                    <img src="images/services/s1.jpg" alt="" /> 
                                 </div>
                                 <div class="list-left-near lln2">
                                    <h5>Service Provider 1</h5>
                           ...
                           <li>
                              <a href="professional-list-details">
                                 <div class="list-left-near lln1"> <img src="images/servicep/s1.jpg" alt="" /> </div>
                                 <div class="list-left-near lln2">
                                    <h5>Service Provider 6</h5>
                                    <span>City: Madkeri</span> 
                                 </div>
                                 <div class="list-left-near lln3"> <span>5.0</span> </div>
                              </a>
                     ...
                     <div class="dir-alp-con-right-1">
                        <div class="row">
                           ...
                           <div class="home-list-pop list-spac">
                              <!--LISTINGS IMAGE-->
                              <div class="col-md-3 list-ser-img"> <img src="images/servicep/s1.jpg" alt="" /> </div>
                              <!--LISTINGS: CONTENT-->
                              <div class="col-md-9 home-list-pop-desc inn-list-pop-desc">
                                 <a href="service-list-details">
                                    <h3>Manpower Service 1</h3>
                                 </a>
                                 <h4>Madkeri</h4>
