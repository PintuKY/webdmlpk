@php
$main_color = 'linear-gradient(92deg, #000D16, #114262, #000D16)';
@endphp
<!doctype html>
        ...
        <div class="b-email-wrap">
            <div class="" style="">
                <div class="b-container">
                    <div class="b-header">
                        <img src="{{url('/public/assets/images/logo/logo.png')}}" width="100">
                    </div>
                </div>
        </div>
        @yield('content')
            <div class="b-footer" style="margin-top: 0px;">
                <div class="b-container">
                    Copyright © 2022 Subbisky. All rights reserved.
                </div>
            </div>
    </body>
</html>
