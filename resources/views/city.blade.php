...
@section('content')
    ...
    <section class="com-padd com-padd-redu-bot1 pad-bot-red-40">
        <div class="container">
            <div class="row">
                <div class="com-title">
                    <h2>Find your <span>Services</span> at <span>{{$city_name}}</span></h2>
                ...
                <div class="dir-hli">
                    <ul>
                        ...
                        <?php $count_seller = \App\Models\Seller::where('service_parent_id',$service->id)->get();
						$ci=0;
						foreach($count_seller as $count)
						{
							if($count->user->city_id == @$city->id)
								$ci++;
						}
						$count_seller = $ci;
						?>
                        <li class="col-md-3 col-sm-3">
                            <a href="{{ url('services',$service->slug) }}?city={{$city_name}}">
                                <div class="dir-hli-5">
                                    <div class="dir-hli-1">
                                        <div class="dir-hli-3">
