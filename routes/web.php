...
Route::get('/city/{slug}', [WelcomeController::class, 'city'])->name('city');
...
Route::post('createaccount',[WelcomeController::class, 'createaccount'])->name('createaccount');
...
Route::group(['prefix'=>'admin'], function(){
    ...
    Route::middleware([SuperAdmin::class])->group(function () {
		...
		Route::get('orders','App\Http\Controllers\Admin\SellerController@orders');
